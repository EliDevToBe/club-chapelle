...
- [x] ✅ **Admin Gestion du club** ClubPanel + member roster (`/admin` club tab): server-filtered paginated list (`GET /api/members/roster`), invite, bind-shell, re-invite, revoke, inline rename; **`developer`** accounts omitted from roster.
