...
**Last reviewed:** 2026-09-01 (repository snapshot below).
...
- [ ] **Admin Gestion du club** surface (`/admin` club tab is a placeholder) for roster and related staff ops.
...
- [ ] **Invitation privacy notice:** e-mail links to **`/privacy-policy`**; activation form shows an **information** notice (no public CGU checkbox).
...
- [ ] **v1.5 invitation notice** (see v1.5 above) — open until invitations exist.
