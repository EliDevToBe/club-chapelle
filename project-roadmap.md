...
**Last reviewed:** 2026-09-01 (repository snapshot below; member invite later the same day).
...
| Date       | Change                                                                 |
| ---------- | ---------------------------------------------------------------------- |
| 2026-09-01 | **v1.5 member invite (Admin):** ClubPanel member table, invite modal, `InviteMember` + accept-invite; privacy notice on mail/form. Manager invite, bind-existing-archer, and promote/demote remain open. |
